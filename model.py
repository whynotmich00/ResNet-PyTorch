...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.layer1 = self._make_layer(arch_cfg[0], block, 16, 1)
        self.layer2 = self._make_layer(arch_cfg[1], block, 32, 2)
        self.layer3 = self._make_layer(arch_cfg[2], block, 64, 2)
